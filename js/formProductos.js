    ...
    const alertContainer = document.getElementById('alertContainer');//nueva
    ...
    const cloudinaryWidget = cloudinary.createUploadWidget({
        ...
        if (!error && result && result.event === "success") {
            ...
            //document.getElementById('preview-container').innerHTML = `
                previewContainer.innerHTML = `<img src="${imagenUrl}" alt="Imagen subida" style="max-width: 200px; margin-top: 10px;">`;
    ...
    document.getElementById('form').addEventListener('submit', function(event) {
        ...
        setTimeout(() => {
            ...
            const registro={
                ...
                categoria,
                precio,
                img: imagenUrl//se guarda la URL de la imagen 
            };
...
//mostrar productos en el DOM 
   /*  window.addEventListener('DOMContentLoaded', () => {
        ...
        productosGuardados.forEach(addItem);
    }); */